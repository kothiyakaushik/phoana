...
CREATE TABLE `users` (
  ...
  `verified_mobile` char(4) COLLATE utf8_unicode_ci NOT NULL,
  `verified_email` char(4) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `users_dup`
--
...
CREATE TABLE `users_dup` (
  ...
  `profile_type` enum('1','2','3') COLLATE utf8_unicode_ci NOT NULL COMMENT '1 = Regular',
  `type` enum('0','1','2','3','4') COLLATE utf8_unicode_ci NOT NULL DEFAULT '0' COMMENT '0 = site user',
  `private_account` enum('0','1') COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  ...
  `app_version` char(12) COLLATE utf8_unicode_ci NOT NULL,
  `gcmid` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `device_type` enum('1','2','3') COLLATE utf8_unicode_ci NOT NULL DEFAULT '1' COMMENT '1 = web',
  `fbid` char(200) COLLATE utf8_unicode_ci NOT NULL,
  `gmailid` char(200) COLLATE utf8_unicode_ci NOT NULL,
  `forgottoken` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `users_dup`
--

INSERT INTO `users_dup` (`id`, `first_name`, `last_name`, `username`, `email`, `password`, `avatar`, `mobile`, `verified_mobile`, `alternative_mobile`, `verified_email`, `userwebsite`, `address`, `image`, `phone`, `birthday`, `profile_type`, `type`, `private_account`, `usernotification`, `latitude`, `longitude`, `status`, `city`, `state`, `country`, `pincode`, `app_version`, `gcmid`, `device_type`, `fbid`, `gmailid`, `forgottoken`, `usertoken`, `remember_token`, `last_login`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Admin', '', 'admin@admin.com', 'admin@admin.com', '$2y$10$injxCimmrVo2UM/slRecRO6n8ZPf6oPKr5kzxrzYnA1KWYs/XeOXK', '', '', '0', '', '0', '', '', '', '', '0000-00-00', '', '1', '0', '0', '', '', '1', '', '', '', '', '', '', '1', '', '', '', '', 'GUUdJIabnFTROqQ4TwjizNRTYJceHWRWWEkrDztEuXtFKVCo6P3mopaQm0Ap', '0000-00-00 00:00:00', '2016-09-28 13:00:00', '2017-01-27 16:33:58', NULL);
...
--
-- Indexes for table `users_dup`
--
ALTER TABLE `users_dup`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id` (`id`);
...
--
-- AUTO_INCREMENT for table `users_dup`
--
ALTER TABLE `users_dup`
