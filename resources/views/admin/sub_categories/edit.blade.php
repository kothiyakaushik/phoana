      ...
      <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            {{Form::open(array('url'=>route('postAdminEditSubCategory',array_merge(['Category' => $Category->id ], Request::all())),'method' => 'post','role'=>'form','class'=>'form-horizontal'))}}
              <div class="box-body">
                <!-- Error Part-->
                <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    {{ Form::select('parent_id', $parentCategory, $Category->parent_id, array('class' => 'form-control select2', 'required'=>'required', 'placeholder' => 'Select Category')) }}
                  </div>
                </div>
                <div class="form-group">
