		...
		$(document).ready(function() {
	        ...
	        $(".category_box").on("change",function(){
			    ...
			    if(parentId != "")
			    {
			    	...
			    	//$('#'+getRefSubCategoryId).html("");
			    	$('.sub_category_box').not(this).html($('<option selected="selected">').text("Select sub category").attr('value',""));
			        $.ajax({
			          url       : "{{route('getAdminSubCategoryByAjax')}}",
