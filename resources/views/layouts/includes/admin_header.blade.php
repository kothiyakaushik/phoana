<header class="main-header">
    ...
    <a href="{{route('dashboard')}}" class="logo">
      ...
      <span class="logo-lg"><b>Striver</b></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer" style="background:#222D32">
                <div class="pull-left">
                  <a href="{{route('getAdminChangePassword')}}" class="btn btn-default btn-flat">Change Password</a>
                </div>
                <div class="pull-right">
                  <center><a href="{{route('getLogOutPage')}}" class="btn btn-default btn-flat">Sign out</a></center>
                </div>
              </li>
            </ul>
          </li>
